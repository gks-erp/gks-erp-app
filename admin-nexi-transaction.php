...
//admin-nexi-transactions.php

$my_page_title=gks_lang('Συναλλαγές NEXI');
$nav_active_array=array('accounting','accounting_eftpos','accounting_eftpos_nexi');


db_open();
stat_record();
$perm_ret=gks_permission_user_can_action($my_wp_user_id, 'gks_nexi_transaction','view',0);
$perm_ret_add=gks_permission_user_can_action($my_wp_user_id, 'gks_nexi_transaction','add',0);
...
$filters[] = array(
  ...
  'title' => gks_lang('Ημερομηνία'),
	...
	'field' => 'gks_nexi_transaction.mydate_add',
	'has_custom_default' => (GKS_ERP_START_VARDIA==0 ? 6 : 5),
//		'mywherepos'=>1,
  'vals' => gks_filter_date_vals(['field'=>'gks_nexi_transaction.mydate_add','future'=>false,'today'=>$today, 'today_vardia'=>$today_vardia]),
);
...
$filters[] = array(
    ...
    'multiselect' => true,
    'field'  => "gks_nexi_transaction.Instalments = %V%",
    'vals' => array(
        //array('value' => -10, 'text' => gks_lang('Χωρίς Χειριστή'),          'sql' => "(gks_nexi_transaction.xeiristis_id=0 or gks_nexi_transaction.xeiristis_id is null)"),
    ),
    'sql' => "SELECT Instalments AS id, Instalments as descr
    FROM gks_nexi_transaction 
...
$filters[] = array(
    ...
    'has_custom_default' => -1,
    'multiselect' => true,
    'field'  => "gks_nexi_transaction.myStatus = %V%",
    'vals' => array(
        array('value' => 1, 'text' => gks_eftpos_has_transaction_status_nexi(1),'sql' => "gks_nexi_transaction.myStatus=1"),
        array('value' => 2, 'text' => gks_eftpos_has_transaction_status_nexi(2),'sql' => "gks_nexi_transaction.myStatus=2"),
        array('value' => 3, 'text' => gks_eftpos_has_transaction_status_nexi(3),'sql' => "gks_nexi_transaction.myStatus=3"),
    ),
);
$filters[] = array(
    'name' => 'fresult',
    ...
    'has_custom_default' => -1,
    'multiselect' => true,
    'field'  => "gks_nexi_transaction.myResult = %V%",
    'vals' => array(
        array('value' => 1, 'text' => gks_eftpos_has_transaction_result_nexi(1),'sql' => "gks_nexi_transaction.myResult=1"),
        array('value' => 2, 'text' => gks_eftpos_has_transaction_result_nexi(2),'sql' => "gks_nexi_transaction.myResult=2"),
        array('value' => 3, 'text' => gks_eftpos_has_transaction_result_nexi(3),'sql' => "gks_nexi_transaction.myResult=3"),
        array('value' => 4, 'text' => gks_eftpos_has_transaction_result_nexi(4),'sql' => "gks_nexi_transaction.myResult=4"),
        array('value' => 5, 'text' => gks_eftpos_has_transaction_result_nexi(5),'sql' => "gks_nexi_transaction.myResult=5"),
        array('value' => 6, 'text' => gks_eftpos_has_transaction_result_nexi(6),'sql' => "gks_nexi_transaction.myResult=6"),
        array('value' => 7, 'text' => gks_eftpos_has_transaction_result_nexi(7),'sql' => "gks_nexi_transaction.myResult=7"),
    ),
);
...
$filters[] = array(
    ...
    'has_custom_default' => -1,
    'multiselect' => true,
    'field'  => "gks_nexi_transaction.Approved = %V%",
    'vals' => array(
        array('value' => 1, 'text' => gks_lang('Ναι'),          'sql' => "gks_nexi_transaction.Approved=1"),
        array('value' => 0, 'text' => gks_lang('Όχι'),          'sql' => "gks_nexi_transaction.Approved=0"),
    ),
);
$filters[] = array(
    'name' => 'fvoided',
    ...
    'has_custom_default' => -1,
    'multiselect' => true,
    'field'  => "gks_nexi_transaction.Voided = %V%",
    'vals' => array(
        array('value' => 1, 'text' => gks_lang('Ναι'),          'sql' => "gks_nexi_transaction.Voided=1"),
        array('value' => 0, 'text' => gks_lang('Όχι'),          'sql' => "gks_nexi_transaction.Voided=0"),
    ),
);
...
//    'has_custom_default' => -1,
//    'multiselect' => true,
//    'field'  => "gks_nexi_transaction.StatusId = '%V%'",
//    'vals' => array(
//        array('value' => -10, 'text' => gks_lang('Κενό StatusId'),          'sql' => "(gks_nexi_transaction.StatusId='' or gks_nexi_transaction.StatusId is null)"),
//    ),
...
$filters[] = array(
    ...
    'has_custom_default' => -1,
    'multiselect' => true,
    'field'  => "gks_nexi_transaction.TxnType = '%V%'",
    'vals' => array(
        array('value' => 0, 'text' => gks_eftpos_has_transaction_type_nexi(0), 'sql' => "gks_nexi_transaction.TxnType=0"),
        array('value' => 1, 'text' => gks_eftpos_has_transaction_type_nexi(1), 'sql' => "gks_nexi_transaction.TxnType=1"),
        array('value' => 2, 'text' => gks_eftpos_has_transaction_type_nexi(2), 'sql' => "gks_nexi_transaction.TxnType=2"),
        array('value' => 3, 'text' => gks_eftpos_has_transaction_type_nexi(3), 'sql' => "gks_nexi_transaction.TxnType=3"),
        array('value' => 4, 'text' => gks_eftpos_has_transaction_type_nexi(4), 'sql' => "gks_nexi_transaction.TxnType=4"),
        array('value' => 5, 'text' => gks_eftpos_has_transaction_type_nexi(5), 'sql' => "gks_nexi_transaction.TxnType=5"),
        array('value' => 6, 'text' => gks_eftpos_has_transaction_type_nexi(6), 'sql' => "gks_nexi_transaction.TxnType=6"),
        array('value' => 7, 'text' => gks_eftpos_has_transaction_type_nexi(7), 'sql' => "gks_nexi_transaction.TxnType=7"),
        array('value' => 8, 'text' => gks_eftpos_has_transaction_type_nexi(8), 'sql' => "gks_nexi_transaction.TxnType=8"),
        array('value' => 9, 'text' => gks_eftpos_has_transaction_type_nexi(9), 'sql' => "gks_nexi_transaction.TxnType=9"),
        array('value' => 101, 'text' => gks_eftpos_has_transaction_type_nexi(101), 'sql' => "gks_nexi_transaction.TxnType=101"),
...
$filters[] = array(
    ...
    'has_custom_default' => -1,
    'multiselect' => true,
    'field'  => "gks_nexi_transaction.PaymentType = '%V%'",
    'vals' => array(
        array('value' => -10,'text' => gks_lang('Κενό'),         'sql' => "gks_nexi_transaction.PaymentType is null"),
        array('value' => 0,  'text' => 'CARD PAYMENT', 'sql' => "gks_nexi_transaction.PaymentType=0"),
        array('value' => 1,  'text' => 'IRIS',         'sql' => "gks_nexi_transaction.PaymentType=1"),
...
$filters[] = array(
    ...
    'has_custom_default' => -1,
    'multiselect' => true,
    'field'  => "gks_nexi_transaction.xeiristis_id = %V%",
    'vals' => array(
        array('value' => -10, 'text' => gks_lang('Χωρίς Χειριστή'),          'sql' => "(gks_nexi_transaction.xeiristis_id=0 or gks_nexi_transaction.xeiristis_id is null)"),
    ),
    'sql' => "SELECT gks_nexi_transaction.xeiristis_id AS id, ".GKS_WP_TABLE_PREFIX."users.gks_nickname as descr
    FROM gks_nexi_transaction LEFT JOIN ".GKS_WP_TABLE_PREFIX."users ON gks_nexi_transaction.xeiristis_id = ".GKS_WP_TABLE_PREFIX."users.ID
    WHERE ".GKS_WP_TABLE_PREFIX."users.ID Is Not Null
    GROUP BY gks_nexi_transaction.xeiristis_id, ".GKS_WP_TABLE_PREFIX."users.gks_nickname
...
if (count($user_companys)>1) {
  $filters[] = array(
    ...
    'has_custom_default' => -1,
    'multiselect' => true,
    'field'  => "gks_nexi_transaction.MID='%V%'",
    'vals' => array(
        //array('value' => -1, 'text' => gks_lang('Όλες'),          'sql' => "(gks_nexi_transaction.StatusId='' or gks_nexi_transaction.StatusId is null)"),
    ),
    'sql' => "
    SELECT gks_nexi_transaction.MID as id, gks_company.company_title as descr
    FROM gks_nexi_transaction 
    LEFT JOIN gks_company ON gks_nexi_transaction.MID = gks_company.nexi_mid
    WHERE gks_nexi_transaction.MID<>''
    and (gks_company.id_company in (".implode(',',$only_id_company).") or gks_company.id_company is null)
    GROUP BY gks_nexi_transaction.MID, gks_company.id_company, gks_company.company_title
...
//    'has_custom_default' => -1,
//    'multiselect' => true,
//    'field'  => "gks_nexi_transaction.CardTypeName = '%V%'",
//    'vals' => array(
//        array('value' => -10, 'text' => gks_lang('Χωρίς Τύπο κάρτας'),          'sql' => "(gks_nexi_transaction.CardTypeName='' or gks_nexi_transaction.CardTypeName is null)"),
//    ),
...
$filters[] = array(
    ...
    'has_custom_default' => -1,
    'multiselect' => true,
    'field'  => "gks_nexi_transaction.Acquirer = '%V%'",
    'vals' => array(
        array('value' => -10, 'text' => gks_lang('Χωρίς Acquirer'),          'sql' => "(gks_nexi_transaction.Acquirer='' or gks_nexi_transaction.Acquirer is null)"),
    ),
...
$sortable = array(
	array('name' => 'soid', 'field' => 'gks_nexi_transaction.id_nexi_transaction'),
	array('name' => 'somydate', 'field' => 'gks_nexi_transaction.mydate_add'),
	array('name' => 'soammount', 'field' => 'gks_nexi_transaction.Amount'),
	array('name' => 'soinstalments', 'field' => 'gks_nexi_transaction.Instalments'),
	array('name' => 'sotip', 'field' => 'gks_nexi_transaction.TipAmount'),
	array('name' => 'sodcc', 'field' => 'gks_nexi_transaction.DccAmount'),
	array('name' => 'socashback', 'field' => 'gks_nexi_transaction.CashbackAmount'),
	array('name' => 'soloyalty', 'field' => 'gks_nexi_transaction.LoyaltyRedemptionAmount'),
	array('name' => 'soapproved', 'field' => 'gks_nexi_transaction.Approved'),
	array('name' => 'sostatus', 'field' => 'gks_nexi_transaction.myStatus'),
	array('name' => 'soresult', 'field' => 'gks_nexi_transaction.myResult'),
	array('name' => 'sovoided', 'field' => 'gks_nexi_transaction.Voided'),
	array('name' => 'somyerror', 'field' => 'gks_nexi_transaction.myerror'),
	array('name' => 'sotxntype', 'field' => 'gks_nexi_transaction.TxnType'),
	array('name' => 'soptype', 'field' => 'gks_nexi_transaction.PaymentType'),
	array('name' => 'soterminal', 'field' => 'gks_nexi_transaction.TID'),
	array('name' => 'sopos_user', 'field' => GKS_WP_TABLE_PREFIX.'users.gks_nickname'),
	array('name' => 'soref', 'field' => 'gks_nexi_transaction.CustomerReference'),
	array('name' => 'socompany', 'field' => 'gks_nexi_transaction.MID'),
	array('name' => 'soacquirer', 'field' => 'gks_nexi_transaction.Acquirer'),
	array('name' => 'socard', 'field' => 'gks_nexi_transaction.CardPAN'),
	array('name' => 'soemail', 'field' => 'gks_nexi_transaction.CustomerEmail'),
	array('name' => 'sophone', 'field' => 'gks_nexi_transaction.CustomerPhone'),
	
	array('name' => 'sorrn', 'field' => 'gks_nexi_transaction.RRN'),
	array('name' => 'soauthcode', 'field' => 'gks_nexi_transaction.AuthCode'),
	array('name' => 'soorrn', 'field' => 'gks_nexi_transaction.OriginalRRN'),
	array('name' => 'sooauthcode', 'field' => 'gks_nexi_transaction.OriginalAuthCode'),
	array('name' => 'sottid', 'field' => 'gks_nexi_transaction.TransactionId_org'),
	array('name' => 'sotime', 'field' => 'gks_nexi_transaction.Timestamp'),
	array('name' => 'sovtime', 'field' => 'gks_nexi_transaction.VoidTimestamp'),
	array('name' => 'sostan', 'field' => 'gks_nexi_transaction.STAN'),
	array('name' => 'sobatchn', 'field' => 'gks_nexi_transaction.BatchNumber'),
	array('name' => 'sobatch', 'field' => 'gks_nexi_transaction.Batch'),
	array('name' => 'sopem', 'field' => 'gks_nexi_transaction.PosEntryMode'),
	array('name' => 'socrypto', 'field' => 'gks_nexi_transaction.Cryptogram'),
	array('name' => 'sohcode', 'field' => 'gks_nexi_transaction.HostResponseCode'),
	array('name' => 'socurr', 'field' => 'gks_nexi_transaction.CurrencyCode'),
	array('name' => 'sodcccurr', 'field' => 'gks_nexi_transaction.DccCurrencyCode'),
);
...
$search_fields = array(
  'gks_nexi_transaction.TransactionId_org',
  'gks_nexi_transaction.CardPAN',
  'gks_nexi_transaction.Id',
  'gks_nexi_transaction.TID',
  'gks_nexi_transaction.MID',
  'gks_nexi_transaction.Cryptogram',
  'gks_nexi_transaction.RRN',
  'gks_nexi_transaction.AuthCode',
  'gks_nexi_transaction.OriginalRRN',
  'gks_nexi_transaction.OriginalAuthCode',
  'gks_nexi_transaction.myerror',
  'gks_nexi_transaction.CustomerEmail',
  'gks_nexi_transaction.CustomerPhone',
);
...
$sql = "SELECT SQL_CALC_FOUND_ROWS gks_nexi_transaction.*, 
...
FROM (gks_nexi_transaction
LEFT JOIN ".GKS_WP_TABLE_PREFIX."users ON gks_nexi_transaction.xeiristis_id = ".GKS_WP_TABLE_PREFIX."users.ID)
LEFT JOIN gks_company ON gks_nexi_transaction.MID = gks_company.nexi_mid
...
if (empty($sorted['sql'])) {
	$sql .= " ORDER BY id_nexi_transaction DESC";
} else {
...
.nexi_status_1 {border-width: 0px;background-color: #cdb635;color: white;font-weight: bold;}
.nexi_status_2 {border-width: 0px;background-color: #978626;color: white;font-weight: bold;}
.nexi_status_3 {border-width: 0px;background-color: green;color: white;font-weight: bold;}
.nexi_status_101 {border-width: 0px;background-color: #660000;color: white;font-weight: bold;}

.nexi_result_1 {border-width: 0px;background-color: green;color: white;font-weight: bold;}
.nexi_result_2 {border-width: 0px;background-color: red;color: white;font-weight: bold;}
.nexi_result_3 {border-width: 0px;background-color: red;color: white;font-weight: bold;}
.nexi_result_4 {border-width: 0px;background-color: red;color: white;font-weight: bold;}
.nexi_result_5 {border-width: 0px;background-color: #cdb635;color: white;font-weight: bold;}
.nexi_result_6 {border-width: 0px;background-color: red;color: white;font-weight: bold;}
.nexi_result_7 {border-width: 0px;background-color: red;color: white;font-weight: bold;}
.nexi_result_101 {border-width: 0px;background-color: #660000;color: white;font-weight: bold;}

.nexi_approved_1 {border-width: 0px;background-color: green;color: white;font-weight: bold;}
.nexi_voided_1 {border-width: 0px;background-color: green;color: white;font-weight: bold;}
</style>
...
<div class="container-fluid">
  <div style="text-align: center"><a href="admin-nexi-refresh.php?today=1" target="_blank" style="
  ...
  "><?php echo gks_lang('Λήψη ξανά των συναλλαγών από NEXI για σήμερα');?></a></div>
</div>
<?php } ?>
...
<thead>
  <tr>	
    ...
    <th class="table-dark" scope="col" style="text-align: center !important;" width="0%" nowrap="nowrap"><?php echo makeSortLink($sortable, $sortable_url, $_GET, 'sodcc', '<span title="DccAmount" class="tooltipster" >Dcc</span>'); ?></th>        
    <th class="table-dark" scope="col" style="text-align: center !important;" width="0%" nowrap="nowrap"><?php echo makeSortLink($sortable, $sortable_url, $_GET, 'socashback', '<span title="CashbackAmount" class="tooltipster" >Back</span>'); ?></th>        
    <th class="table-dark" scope="col" style="text-align: center !important;" width="0%" nowrap="nowrap"><?php echo makeSortLink($sortable, $sortable_url, $_GET, 'soloyalty', '<span title="LoyaltyRedemptionAmount" class="tooltipster" >Loyalty</span>'); ?></th>        
    ...
    <th class="table-dark" scope="col" style="text-align: center !important;" width="10%" nowrap="nowrap"><?php echo makeSortLink($sortable, $sortable_url, $_GET, 'sotxntype', '<span title="TxnType" class="tooltipster" >'.gks_lang('Τύπος').'</span>'); ?></th>        
    <th class="table-dark" scope="col" style="text-align: center !important;" width="0%" nowrap="nowrap"><?php echo makeSortLink($sortable, $sortable_url, $_GET, 'soptype', '<span title="'.gks_lang('Τύπος Πληρωμής').'" class="tooltipster" >'.gks_lang('Τύπος Π.').'</span>'); ?></th>        
...
?>
  <tr>
    ...
    <td nowrap class="mytdcml"><?php echo $row['id_nexi_transaction'];?></td>   


    <td class="mytdcm"><a href="admin-nexi-transaction-raw.php?mtid=<?php echo $row['id_nexi_transaction'];?>" target="_blank">R</a></td>
    <td class="mytdcm">
        <i class="fas fa-sync nexi_reload" data-id="<?php echo $row['id_nexi_transaction'];?>"></i>
    </td>  
    ...
    <td nowrap class="mytdcm nexi_status_<?php echo $row['myStatus'];?>"><?php echo gks_eftpos_has_transaction_status_nexi($row['myStatus']);?></td>
    <td nowrap class="mytdcm nexi_result_<?php echo $row['myResult'];?>"><?php echo gks_eftpos_has_transaction_result_nexi($row['myResult']);?></td>
    <td nowrap class="mytdcm nexi_approved_<?php echo $row['Approved'];?>"><?php echo myimg010($row['Approved']);?></td>
    <td nowrap class="mytdcm nexi_voided_<?php echo $row['Voided'];?>"><?php echo myimg01($row['Voided']);?></td>
     
    <td class="gks_td08"><div class="gks_dive1"><div class="gks_dive2 mydivexpand"><?php 
      echo trim_gks($row['myerror']);
    ?></div></div></td>
    <td nowrap class="mytdcm"><?php echo gks_eftpos_has_transaction_type_nexi($row['TxnType']);?></td>
    ...
    <td nowrap class="mytdcml div_xeiristis" data-id="<?php echo $row['id_nexi_transaction'];?>">
...
jQuery(document).ready(function($) {
  ...
  $('.nexi_reload').click(function() {
    ...
    datasend='myid=' + myid
    $.ajax({
			url: '/my/admin-nexi-transaction-reload.php',
			type: 'POST',
			cache: false,
			dataType: 'json',
			data: datasend,
    ...
    buttons: [
      {
        ...
        click: function() {
          ...
          $.ajax({
      			url: '/my/admin-nexi-transaction-select-xeiristis-exec.php',
      			type: 'POST',
      			cache: false,
      			dataType: 'json',
      			data: datasend,
  ...
  $('.div_xeiristis').click(function(event) {
    ...
    datasend='myid=' + myid
    $.ajax({
			url: '/my/admin-nexi-transaction-select-xeiristis.php',
			type: 'POST',
			cache: false,
			dataType: 'json',
			data: datasend,
