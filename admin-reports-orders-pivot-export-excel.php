...
$my_page_title=gks_lang('Αναφορά - Pivot Table - Παραγγελίες Connect - Εξαγωγή σε Excel');
...
$ret = gks_pivot_table_convert_to_excel($source,$mytable,gks_lang('Παραγγελίες Connect'));
