...
$my_page_title=gks_lang('Αναφορά - Pivot Table - Δελτία με Είδη');
$nav_active_array=array('warehouse','warehouse_whi_mov_pivot9');
...
include_once('admin-reports-whi-mov-pivot9_filters.php');
...
$_gks_session['temp']['wherepivot9']=$sql;
gks_erp_cookie_save();
...
jQuery(document).ready(function($) {
  ...
  $.ajax({
		url: '/my/admin-reports-whi-mov-pivot9-json.php',
		type: 'POST',
		cache: false,
		dataType: 'json',
		data: '',
  ...
  $('#export_pivot_to_excel').click(function() {
    ...
    $.ajax({
			url: '/my/admin-reports-whi-mov-pivot9-export-excel.php',
			type: 'POST',
			cache: false,
			dataType: 'json',
			data: datasend,
