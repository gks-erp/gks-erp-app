...
$my_page_title=gks_lang('Αναφορά - Pivot Table - Πληρωμές');
$nav_active_array=array('accounting','accounting_pay_pivot6');
...
$_gks_session['temp']['wherepivot6']=$sql;
gks_erp_cookie_save();
...
jQuery(document).ready(function($) {
  ...
  $.ajax({
		url: '/my/admin-reports-acc-pay-pivot6-json.php',
		type: 'POST',
		cache: false,
		dataType: 'json',
		data: '',
  ...
  $('#export_pivot_to_excel').click(function() {
    ...
    $.ajax({
			url: '/my/admin-reports-acc-pay-pivot6-export-excel.php',
			type: 'POST',
			cache: false,
			dataType: 'json',
			data: datasend,
