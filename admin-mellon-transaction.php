...
//admin-mellon-transactions.php

$my_page_title=gks_lang('Συναλλαγές Mellon Technologies');
$nav_active_array=array('accounting','accounting_eftpos','accounting_eftpos_mellon');


db_open();
stat_record();
$perm_ret=gks_permission_user_can_action($my_wp_user_id, 'gks_mellon_transaction','view',0);
$perm_ret_add=gks_permission_user_can_action($my_wp_user_id, 'gks_mellon_transaction','add',0);
...
$filters[] = array(
  ...
  'title' => gks_lang('Ημερομηνία'),
	...
	'field' => 'gks_mellon_transaction.mydate_add',
	'has_custom_default' => (GKS_ERP_START_VARDIA==0 ? 6 : 5),
//		'mywherepos'=>1,
  'vals' => gks_filter_date_vals(['field'=>'gks_mellon_transaction.mydate_add','future'=>false,'today'=>$today, 'today_vardia'=>$today_vardia]),
);
...
$filters[] = array(
    ...
    'multiselect' => true,
    'field'  => "gks_mellon_transaction.Instalments = %V%",
    'vals' => array(
        //array('value' => -10, 'text' => gks_lang('Χωρίς Χειριστή'),          'sql' => "(gks_mellon_transaction.xeiristis_id=0 or gks_mellon_transaction.xeiristis_id is null)"),
    ),
    'sql' => "SELECT Instalments AS id, Instalments as descr
    FROM gks_mellon_transaction 
...
$filters[] = array(
    ...
    'has_custom_default' => -1,
    'multiselect' => true,
    'field'  => "gks_mellon_transaction.myStatus = %V%",
    'vals' => array(
        array('value' => 1, 'text' => gks_eftpos_has_transaction_status_mellon(1),'sql' => "gks_mellon_transaction.myStatus=1"),
        array('value' => 2, 'text' => gks_eftpos_has_transaction_status_mellon(2),'sql' => "gks_mellon_transaction.myStatus=2"),
        array('value' => 3, 'text' => gks_eftpos_has_transaction_status_mellon(3),'sql' => "gks_mellon_transaction.myStatus=3"),
    ),
);
$filters[] = array(
    'name' => 'fresult',
    ...
    'has_custom_default' => -1,
    'multiselect' => true,
    'field'  => "gks_mellon_transaction.myResult = %V%",
    'vals' => array(
        array('value' => 1, 'text' => gks_eftpos_has_transaction_result_mellon(1),'sql' => "gks_mellon_transaction.myResult=1"),
        array('value' => 2, 'text' => gks_eftpos_has_transaction_result_mellon(2),'sql' => "gks_mellon_transaction.myResult=2"),
        array('value' => 3, 'text' => gks_eftpos_has_transaction_result_mellon(3),'sql' => "gks_mellon_transaction.myResult=3"),
        array('value' => 4, 'text' => gks_eftpos_has_transaction_result_mellon(4),'sql' => "gks_mellon_transaction.myResult=4"),
        array('value' => 5, 'text' => gks_eftpos_has_transaction_result_mellon(5),'sql' => "gks_mellon_transaction.myResult=5"),
        array('value' => 6, 'text' => gks_eftpos_has_transaction_result_mellon(6),'sql' => "gks_mellon_transaction.myResult=6"),
        array('value' => 7, 'text' => gks_eftpos_has_transaction_result_mellon(7),'sql' => "gks_mellon_transaction.myResult=7"),
    ),
);
...
$filters[] = array(
    ...
    'has_custom_default' => -1,
    'multiselect' => true,
    'field'  => "gks_mellon_transaction.Approved = %V%",
    'vals' => array(
        array('value' => 1, 'text' => gks_lang('Ναι'),          'sql' => "gks_mellon_transaction.Approved=1"),
        array('value' => 0, 'text' => gks_lang('Όχι'),          'sql' => "gks_mellon_transaction.Approved=0"),
    ),
);
$filters[] = array(
    'name' => 'fvoided',
    ...
    'has_custom_default' => -1,
    'multiselect' => true,
    'field'  => "gks_mellon_transaction.Voided = %V%",
    'vals' => array(
        array('value' => 1, 'text' => gks_lang('Ναι'),          'sql' => "gks_mellon_transaction.Voided=1"),
        array('value' => 0, 'text' => gks_lang('Όχι'),          'sql' => "gks_mellon_transaction.Voided=0"),
    ),
);
...
//    'has_custom_default' => -1,
//    'multiselect' => true,
//    'field'  => "gks_mellon_transaction.StatusId = '%V%'",
//    'vals' => array(
//        array('value' => -10, 'text' => gks_lang('Κενό StatusId'),          'sql' => "(gks_mellon_transaction.StatusId='' or gks_mellon_transaction.StatusId is null)"),
//    ),
...
$filters[] = array(
    ...
    'has_custom_default' => -1,
    'multiselect' => true,
    'field'  => "gks_mellon_transaction.TxnType = '%V%'",
    'vals' => array(
        array('value' => 0, 'text' => gks_eftpos_has_transaction_type_mellon(0), 'sql' => "gks_mellon_transaction.TxnType=0"),
        array('value' => 1, 'text' => gks_eftpos_has_transaction_type_mellon(1), 'sql' => "gks_mellon_transaction.TxnType=1"),
        array('value' => 2, 'text' => gks_eftpos_has_transaction_type_mellon(2), 'sql' => "gks_mellon_transaction.TxnType=2"),
        array('value' => 3, 'text' => gks_eftpos_has_transaction_type_mellon(3), 'sql' => "gks_mellon_transaction.TxnType=3"),
        array('value' => 4, 'text' => gks_eftpos_has_transaction_type_mellon(4), 'sql' => "gks_mellon_transaction.TxnType=4"),
        array('value' => 5, 'text' => gks_eftpos_has_transaction_type_mellon(5), 'sql' => "gks_mellon_transaction.TxnType=5"),
        array('value' => 6, 'text' => gks_eftpos_has_transaction_type_mellon(6), 'sql' => "gks_mellon_transaction.TxnType=6"),
        array('value' => 7, 'text' => gks_eftpos_has_transaction_type_mellon(7), 'sql' => "gks_mellon_transaction.TxnType=7"),
        array('value' => 8, 'text' => gks_eftpos_has_transaction_type_mellon(8), 'sql' => "gks_mellon_transaction.TxnType=8"),
        array('value' => 9, 'text' => gks_eftpos_has_transaction_type_mellon(9), 'sql' => "gks_mellon_transaction.TxnType=9"),
        array('value' => 101, 'text' => gks_eftpos_has_transaction_type_mellon(101), 'sql' => "gks_mellon_transaction.TxnType=101"),
...
$filters[] = array(
    ...
    'has_custom_default' => -1,
    'multiselect' => true,
    'field'  => "gks_mellon_transaction.PaymentType = '%V%'",
    'vals' => array(
        array('value' => -10,'text' => gks_lang('Κενό'),         'sql' => "gks_mellon_transaction.PaymentType is null"),
        array('value' => 0,  'text' => 'CARD PAYMENT', 'sql' => "gks_mellon_transaction.PaymentType=0"),
        array('value' => 1,  'text' => 'IRIS',         'sql' => "gks_mellon_transaction.PaymentType=1"),
...
$filters[] = array(
    ...
    'has_custom_default' => -1,
    'multiselect' => true,
    'field'  => "gks_mellon_transaction.CardType = '%V%'",
    'vals' => array(
        array('value' => -10, 'text' => gks_lang('Χωρίς Τύπο κάρτας'),          'sql' => "(gks_mellon_transaction.CardType='' or gks_mellon_transaction.CardType is null)"),
    ),
...
$filters[] = array(
    ...
    'has_custom_default' => -1,
    'multiselect' => true,
    'field'  => "gks_mellon_transaction.xeiristis_id = %V%",
    'vals' => array(
        array('value' => -10, 'text' => gks_lang('Χωρίς Χειριστή'),          'sql' => "(gks_mellon_transaction.xeiristis_id=0 or gks_mellon_transaction.xeiristis_id is null)"),
    ),
    'sql' => "SELECT gks_mellon_transaction.xeiristis_id AS id, ".GKS_WP_TABLE_PREFIX."users.gks_nickname as descr
    FROM gks_mellon_transaction LEFT JOIN ".GKS_WP_TABLE_PREFIX."users ON gks_mellon_transaction.xeiristis_id = ".GKS_WP_TABLE_PREFIX."users.ID
    WHERE ".GKS_WP_TABLE_PREFIX."users.ID Is Not Null
    GROUP BY gks_mellon_transaction.xeiristis_id, ".GKS_WP_TABLE_PREFIX."users.gks_nickname
...
if (count($user_companys)>1) {
  $filters[] = array(
    ...
    'has_custom_default' => -1,
    'multiselect' => true,
    'field'  => "gks_mellon_transaction.MID='%V%'",
    'vals' => array(
        //array('value' => -1, 'text' => gks_lang('Όλες'),          'sql' => "(gks_mellon_transaction.StatusId='' or gks_mellon_transaction.StatusId is null)"),
    ),
    'sql' => "
    SELECT gks_mellon_transaction.MID as id, gks_company.company_title as descr
    FROM gks_mellon_transaction 
    LEFT JOIN gks_company ON gks_mellon_transaction.MID = gks_company.mellon_mid
    WHERE gks_mellon_transaction.MID<>''
    and (gks_company.id_company in (".implode(',',$only_id_company).") or gks_company.id_company is null)
    GROUP BY gks_mellon_transaction.MID, gks_company.id_company, gks_company.company_title
...
//    'has_custom_default' => -1,
//    'multiselect' => true,
//    'field'  => "gks_mellon_transaction.CardTypeName = '%V%'",
//    'vals' => array(
//        array('value' => -10, 'text' => gks_lang('Χωρίς Τύπο κάρτας'),          'sql' => "(gks_mellon_transaction.CardTypeName='' or gks_mellon_transaction.CardTypeName is null)"),
//    ),
...
$filters[] = array(
    ...
    'has_custom_default' => -1,
    'multiselect' => true,
    'field'  => "gks_mellon_transaction.Acquirer = '%V%'",
    'vals' => array(
        array('value' => -10, 'text' => gks_lang('Χωρίς Acquirer'),          'sql' => "(gks_mellon_transaction.Acquirer='' or gks_mellon_transaction.Acquirer is null)"),
    ),
...
$sortable = array(
	array('name' => 'soid', 'field' => 'gks_mellon_transaction.id_mellon_transaction'),
	array('name' => 'somydate', 'field' => 'gks_mellon_transaction.mydate_add'),
	array('name' => 'soammount', 'field' => 'gks_mellon_transaction.Amount'),
	array('name' => 'soinstalments', 'field' => 'gks_mellon_transaction.Instalments'),
	array('name' => 'sotip', 'field' => 'gks_mellon_transaction.TipAmount'),
	array('name' => 'sodcc', 'field' => 'gks_mellon_transaction.DccAmount'),
	array('name' => 'socashback', 'field' => 'gks_mellon_transaction.CashbackAmount'),
	array('name' => 'soloyalty', 'field' => 'gks_mellon_transaction.LoyaltyRedemptionAmount'),
	array('name' => 'soapproved', 'field' => 'gks_mellon_transaction.Approved'),
	array('name' => 'sovoided', 'field' => 'gks_mellon_transaction.Voided'),
	array('name' => 'somyerror', 'field' => 'gks_mellon_transaction.myerror'),
	
	array('name' => 'sotxntype', 'field' => 'gks_mellon_transaction.TxnType'),
	array('name' => 'soptype', 'field' => 'gks_mellon_transaction.PaymentType'),
	array('name' => 'socardtype', 'field' => 'gks_mellon_transaction.CardType'),
	array('name' => 'soterminal', 'field' => 'gks_mellon_transaction.TID'),
	array('name' => 'sopos_user', 'field' => GKS_WP_TABLE_PREFIX.'users.gks_nickname'),
	array('name' => 'soref', 'field' => 'gks_mellon_transaction.CustomerReference'),
	array('name' => 'socompany', 'field' => 'gks_mellon_transaction.MID'),
	array('name' => 'soacquirer', 'field' => 'gks_mellon_transaction.Acquirer'),
	array('name' => 'socard', 'field' => 'gks_mellon_transaction.CardPAN'),
	array('name' => 'soemail', 'field' => 'gks_mellon_transaction.CustomerEmail'),
	array('name' => 'sophone', 'field' => 'gks_mellon_transaction.CustomerPhone'),
	
	array('name' => 'sorrn', 'field' => 'gks_mellon_transaction.RRN'),
	array('name' => 'soauthcode', 'field' => 'gks_mellon_transaction.AuthCode'),
	array('name' => 'soorrn', 'field' => 'gks_mellon_transaction.OriginalRRN'),
	array('name' => 'sooauthcode', 'field' => 'gks_mellon_transaction.OriginalAuthCode'),
	array('name' => 'sottid', 'field' => 'gks_mellon_transaction.TransactionId_org'),
	array('name' => 'sotime', 'field' => 'gks_mellon_transaction.Timestamp'),
	array('name' => 'sovtime', 'field' => 'gks_mellon_transaction.VoidTimestamp'),
	array('name' => 'sostan', 'field' => 'gks_mellon_transaction.STAN'),
	array('name' => 'sobatchn', 'field' => 'gks_mellon_transaction.BatchNumber'),
	array('name' => 'sobatch', 'field' => 'gks_mellon_transaction.Batch'),
	array('name' => 'sopem', 'field' => 'gks_mellon_transaction.PosEntryMode'),
	array('name' => 'socrypto', 'field' => 'gks_mellon_transaction.Cryptogram'),
	array('name' => 'sohcode', 'field' => 'gks_mellon_transaction.HostResponseCode'),
	array('name' => 'socurr', 'field' => 'gks_mellon_transaction.CurrencyCode'),
	array('name' => 'sodcccurr', 'field' => 'gks_mellon_transaction.DccCurrencyCode'),
);
...
$search_fields = array(
  'gks_mellon_transaction.TransactionId_org',
  'gks_mellon_transaction.CardPAN',
  'gks_mellon_transaction.Id',
  'gks_mellon_transaction.TID',
  'gks_mellon_transaction.MID',
  'gks_mellon_transaction.Cryptogram',
  'gks_mellon_transaction.RRN',
  'gks_mellon_transaction.AuthCode',
  'gks_mellon_transaction.OriginalRRN',
  'gks_mellon_transaction.OriginalAuthCode',
  'gks_mellon_transaction.myerror',
  'gks_mellon_transaction.CustomerEmail',
  'gks_mellon_transaction.CustomerPhone',
);
...
$sql = "SELECT SQL_CALC_FOUND_ROWS gks_mellon_transaction.*, 
...
FROM (gks_mellon_transaction
LEFT JOIN ".GKS_WP_TABLE_PREFIX."users ON gks_mellon_transaction.xeiristis_id = ".GKS_WP_TABLE_PREFIX."users.ID)
LEFT JOIN gks_company ON gks_mellon_transaction.MID = gks_company.mellon_mid
...
if (empty($sorted['sql'])) {
	$sql .= " ORDER BY id_mellon_transaction DESC";
} else {
...
.mellon_status_1 {border-width: 0px;background-color: #cdb635;color: white;font-weight: bold;}
.mellon_status_2 {border-width: 0px;background-color: #978626;color: white;font-weight: bold;}
.mellon_status_3 {border-width: 0px;background-color: green;color: white;font-weight: bold;}
.mellon_status_101 {border-width: 0px;background-color: #660000;color: white;font-weight: bold;}

.mellon_result_1 {border-width: 0px;background-color: green;color: white;font-weight: bold;}
.mellon_result_2 {border-width: 0px;background-color: red;color: white;font-weight: bold;}
.mellon_result_3 {border-width: 0px;background-color: red;color: white;font-weight: bold;}
.mellon_result_4 {border-width: 0px;background-color: red;color: white;font-weight: bold;}
.mellon_result_5 {border-width: 0px;background-color: #cdb635;color: white;font-weight: bold;}
.mellon_result_6 {border-width: 0px;background-color: red;color: white;font-weight: bold;}
.mellon_result_7 {border-width: 0px;background-color: red;color: white;font-weight: bold;}
.mellon_result_101 {border-width: 0px;background-color: #660000;color: white;font-weight: bold;}

.mellon_approved_1 {border-width: 0px;background-color: green;color: white;font-weight: bold;}
.mellon_voided_1 {border-width: 0px;background-color: green;color: white;font-weight: bold;}
</style>
...
<div class="container-fluid">
  <div style="text-align: center"><a href="admin-mellon-refresh.php?today=1" target="_blank" style="
  ...
  "><?php echo gks_lang('Λήψη ξανά των συναλλαγών από Mellon για σήμερα');?></a></div>
</div>
<?php } ?>
...
<thead>
  <tr>	
    ...
    <th class="table-dark" scope="col" style="text-align: center !important;" width="0%" nowrap="nowrap"><?php echo makeSortLink($sortable, $sortable_url, $_GET, 'sodcc', '<span class="tooltipster" title="Dcc Amount">Dcc</span>'); ?></th>        
    ...
    <th class="table-dark" scope="col" style="text-align: center !important;" width="0%" nowrap="nowrap"><?php echo makeSortLink($sortable, $sortable_url, $_GET, 'soauthcode', '<span class="tooltipster" title="Auth Code">AuthCode</span>'); ?></th>        
    <th class="table-dark" scope="col" style="text-align: center !important;" width="0%" nowrap="nowrap"><?php echo makeSortLink($sortable, $sortable_url, $_GET, 'soorrn', '<span class="tooltipster" title="Original RRN">ORRN</span>'); ?></th>        
    <th class="table-dark" scope="col" style="text-align: center !important;" width="0%" nowrap="nowrap"><?php echo makeSortLink($sortable, $sortable_url, $_GET, 'sooauthcode', '<span class="tooltipster" title="Original Auth Code">OAuthCode</span>'); ?></th>        
    ...
    <th class="table-dark" scope="col" style="text-align: center !important;" width="0%" nowrap="nowrap"><?php echo makeSortLink($sortable, $sortable_url, $_GET, 'sovtime', '<span class="tooltipster" title="Void Timestamp">VTime</span>'); ?></th>        
    ...
    <th class="table-dark" scope="col" style="text-align: center !important;" width="0%" nowrap="nowrap"><?php echo makeSortLink($sortable, $sortable_url, $_GET, 'sobatchn', '<span class="tooltipster" title="Batch Number">BatchNumber</span>'); ?></th>        
    ...
    <th class="table-dark" scope="col" style="text-align: center !important;" width="0%" nowrap="nowrap"><?php echo makeSortLink($sortable, $sortable_url, $_GET, 'sopem', '<span class="tooltipster" title="Pos Entry Mode">PEMode</span>'); ?></th>        
    ...
    <th class="table-dark" scope="col" style="text-align: center !important;" width="0%" nowrap="nowrap"><?php echo makeSortLink($sortable, $sortable_url, $_GET, 'sohcode', '<span class="tooltipster" title="Host Response Code">HCode</span>'); ?></th>        
    <th class="table-dark" scope="col" style="text-align: center !important;" width="0%" nowrap="nowrap"><?php echo makeSortLink($sortable, $sortable_url, $_GET, 'socurr', '<span class="tooltipster" title="Currency Code">Curr</span>'); ?></th>        
    <th class="table-dark" scope="col" style="text-align: center !important;" width="0%" nowrap="nowrap"><?php echo makeSortLink($sortable, $sortable_url, $_GET, 'sodcccurr', '<span class="tooltipster" title="Dcc Currency Code">DCC Curr</span>'); ?></th>        
...
?>
  <tr>
    ...
    <td nowrap class="mytdcml"><?php echo $row['id_mellon_transaction'];?></td>   

    <td class="mytdcm"><a href="admin-mellon-transaction-raw.php?mtid=<?php echo $row['id_mellon_transaction'];?>" target="_blank">R</a></td>
    <td class="mytdcm">
        <i class="fas fa-sync mellon_reload" data-id="<?php echo $row['id_mellon_transaction'];?>"></i>
    </td>  
    ...
    <td nowrap class="mytdcm mellon_status_<?php echo $row['myStatus'];?>"><?php echo gks_eftpos_has_transaction_status_mellon($row['myStatus']);?></td>
    <td nowrap class="mytdcm mellon_result_<?php echo $row['myResult'];?>"><?php echo gks_eftpos_has_transaction_result_mellon($row['myResult']);?></td>
    <td nowrap class="mytdcm mellon_approved_<?php echo $row['Approved'];?>"><?php echo myimg010($row['Approved']);?></td>
    <td nowrap class="mytdcm mellon_voided_<?php echo $row['Voided'];?>"><?php echo myimg01($row['Voided']);?></td>
     
    <td class="gks_td08"><div class="gks_dive1"><div class="gks_dive2 mydivexpand"><?php 
      echo trim_gks($row['myerror']);
    ?></div></div></td>
    <td nowrap class="mytdcm"><?php echo gks_eftpos_has_transaction_type_mellon($row['TxnType']);?></td>
    ...
    <td nowrap class="mytdcml div_xeiristis" data-id="<?php echo $row['id_mellon_transaction'];?>">
...
jQuery(document).ready(function($) {
  ...
  $('.mellon_reload').click(function() {
    ...
    datasend='myid=' + myid
    $.ajax({
			url: '/my/admin-mellon-transaction-reload.php',
			type: 'POST',
			cache: false,
			dataType: 'json',
			data: datasend,
    ...
    buttons: [
      {
        ...
        click: function() {
          ...
          $.ajax({
      			url: '/my/admin-mellon-transaction-select-xeiristis-exec.php',
      			type: 'POST',
      			cache: false,
      			dataType: 'json',
      			data: datasend,
  ...
  $('.div_xeiristis').click(function(event) {
    ...
    datasend='myid=' + myid
    $.ajax({
			url: '/my/admin-mellon-transaction-select-xeiristis.php',
			type: 'POST',
			cache: false,
			dataType: 'json',
			data: datasend,
