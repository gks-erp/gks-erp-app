...
$my_page_title=gks_lang('Αναφορά - Pivot Table - Παραστατικά με Είδη');
...
include_once('admin-reports-acc-inv-pivot5_filters.php');
...
$_gks_session['temp']['wherepivot5']=$sql;
gks_erp_cookie_save();
...
jQuery(document).ready(function($) {
  ...
  $.ajax({
		url: '/my/admin-reports-acc-inv-pivot5-json.php',
		type: 'POST',
		cache: false,
		dataType: 'json',
		data: '',
  ...
  $('#export_pivot_to_excel').click(function() {
    ...
    $.ajax({
			url: '/my/admin-reports-acc-inv-pivot5-export-excel.php',
			type: 'POST',
			cache: false,
			dataType: 'json',
			data: datasend,
