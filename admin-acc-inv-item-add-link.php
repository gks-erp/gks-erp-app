...
$my_page_title=gks_lang('Προσθήκη συνδέσμου σε παραστατικό');
db_open();
stat_record();
...
acc_inv_id,url,mydate,ip,user_id
) values (
...
$html='<tr id="tr_links_url_'.$id.'">
  ...
  <td nowrap align="center">
    <i class="fas fa-trash-alt deleterow" data-deleteafter="gks_fnc_links_delete_after|'.$id.'" data-id="'.$id.'" data-model="gks_acc_inv_links" style="font-size:120%;color:#dc3545;cursor:pointer;"></i>
  </td>
