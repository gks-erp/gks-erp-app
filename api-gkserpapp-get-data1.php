...
$myParameters = urldecode($_POST['r']).$myParameters. '01202935820skdfjghsdkfh293485290345djfghkdjfgh9032480253498';
//echo $myParameters;
//die();
$myreturnmd5 = md5($myParameters);
...
where erp_app_disabled=0 and erp_app_token<> '' and erp_app_token='".$db_link->escape_string(urldecode($_POST['sc']))."' limit 1";
...
$sql="insert into gks_erp_app_ping (erp_app_id,mydate,myip,pctime,pcusername,pcname,rand1,ticks,winver,appver,lanips,hdwd,screw,screh,mac) values (
".$id_erp_app.",
now(),
