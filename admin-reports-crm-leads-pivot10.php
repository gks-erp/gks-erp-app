...
$my_page_title=gks_lang('Αναφορά - Pivot Table - Ευκαιρίες');
$nav_active_array=array('crm','crm_leads_pivot10');
...
$_gks_session['temp']['where_crm_leads_pivot10']=$sql;
gks_erp_cookie_save();
...
jQuery(document).ready(function($) {
  ...
  mydata.vals=[gks_lang('Ευκαιρίες')];
  ...
  $.ajax({
		url: '/my/admin-reports-crm-leads-pivot10-json.php',
		type: 'POST',
		cache: false,
		dataType: 'json',
		data: '',
  ...
  $('#export_pivot_to_excel').click(function() {
    ...
    $.ajax({
			url: '/my/admin-reports-crm-leads-pivot10-export-excel.php',
			type: 'POST',
			cache: false,
			dataType: 'json',
			data: datasend,
