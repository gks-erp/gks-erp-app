...
$my_page_title=gks_lang('Αναφορά - Pivot Table - Παραγγελίες');
$nav_active_array=array('sales','sales_orders_pivot2');
...
$_gks_session['temp']['wherepivot2']=$sql;
gks_erp_cookie_save();
//echo $_gks_session['temp']['wherepivot2']; die();
...
jQuery(document).ready(function($) {
  ...
  $.ajax({
		url: '/my/admin-reports-orders-pivot2-json.php',
		type: 'POST',
		cache: false,
		dataType: 'json',
		data: '',
  ...
  $('#export_pivot_to_excel').click(function() {
    ...
    $.ajax({
			url: '/my/admin-reports-orders-pivot2-export-excel.php',
			type: 'POST',
			cache: false,
			dataType: 'json',
			data: datasend,
