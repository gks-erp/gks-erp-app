...
$perm_ret=gks_permission_user_can_action($my_wp_user_id, 'gks_country',($id==-1 ? 'add' : 'view'),$id);
...
if ($id==-1) {
  ...
  $row['myip'] ='';
  $row['id_country']=-1;
  $row['country_initials']='';
  $row['country_initials3'] ='';
  $row['country_ee'] ='';
  $row['country_ISO_3166_1'] =0;
  $row['country_name'] ='';
  $row['country_lang'] ='';
  $row['phone_code'] ='';
  ...
  $my_page_title=gks_lang('Νέα Χώρα');


} else {
 $sql ="SELECT gks_country.*,
  ".GKS_WP_TABLE_PREFIX."users_add.gks_nickname as gks_nickname_add, ".GKS_WP_TABLE_PREFIX."users_edit.gks_nickname as gks_nickname_edit
  FROM gks_country
  LEFT JOIN ".GKS_WP_TABLE_PREFIX."users as ".GKS_WP_TABLE_PREFIX."users_add on gks_country.user_id_add = ".GKS_WP_TABLE_PREFIX."users_add.ID
  LEFT JOIN ".GKS_WP_TABLE_PREFIX."users as ".GKS_WP_TABLE_PREFIX."users_edit on gks_country.user_id_edit = ".GKS_WP_TABLE_PREFIX."users_edit.ID
  where id_country = ".$id;
  ...
  $my_page_title=gks_lang('Χώρα').': '.$row['country_name'];
  $object_title=$row['country_name'];
}
...
$lang_data_obj=gks_lang_data_obj_prepare('gks_country','default');
...
<div class="container-fluid gksitemheader">
  <div class="row align-items-center">
    <div class="col-sm-12" style="text-align:center">
      <?php if ($id > 0) {?>
        <h3><?php echo gks_lang('Χώρα');?>: <span class="gks_object_badge_secondary">#<?php echo $id;?></span> <?php echo $object_title;?></h3>
      <?php } else { ?>
        <h3><?php echo gks_lang('Χώρα');?>: <span class="gks_object_badge_secondary">#<?php echo gks_lang('Νέα');?></span></h3>
      <?php }?>
    </div>
  </div>
</div>
      ...
      <div class="card gks_card_expand">
        ...
        <div class="card-body" <?php echo gks_card_body('bas');?>>  
          ...
          <div class="form-group row">
            <label class="col-sm-4 col-form-label form-control-sm text-sm-right" for="country_name"><?php echo gks_lang('Χώρα');?>:</label>
            <div class="col-sm-8">
              <input type="text" class="form-control form-control-sm myneedsave" id="country_name"  value="<?php echo htmlspecialchars_gks($row['country_name']);?>">
            </div>
          </div>
          
          <?php 
          echo gks_lang_data_obj_render_html($lang_data_obj,$row,array('country_name'));
          ?>
          <div class="form-group row">
            <label class="col-sm-4 col-form-label form-control-sm text-sm-right" for="country_initials"><?php echo gks_lang('Αρχικά (2 χαρακτήρες)');?>:</label>
            <div class="col-sm-8">
              <input type="text" class="form-control form-control-sm myneedsave" id="country_initials"  value="<?php echo htmlspecialchars_gks($row['country_initials']);?>">
            </div>
          </div>
          <div class="form-group row">
            <label class="col-sm-4 col-form-label form-control-sm text-sm-right" for="country_initials3"><?php echo gks_lang('Αρχικά (3 χαρακτήρες)');?>:</label>
            <div class="col-sm-8">
              <input type="text" class="form-control form-control-sm myneedsave" id="country_initials3"  value="<?php echo htmlspecialchars_gks($row['country_initials3']);?>">
            </div>
          </div>
          <div class="form-group row">
            <label class="col-sm-4 col-form-label form-control-sm text-sm-right" for="country_ISO_3166_1"><?php echo gks_lang('ISO 3166-1');?>:</label>
            <div class="col-sm-8">
              <input type="number" class="form-control form-control-sm myneedsave" id="country_ISO_3166_1"  value="<?php if ($row['country_ISO_3166_1']!=0) echo $row['country_ISO_3166_1'];?>">
            </div>
          </div>
          <div class="form-group row">
            <label class="col-sm-4 col-form-label form-control-sm text-sm-right" for="country_lang"><?php echo gks_lang('Γλώσσα');?>:</label>
            <div class="col-sm-8">
              <input type="text" class="form-control form-control-sm myneedsave" id="country_lang" value="<?php echo htmlspecialchars_gks($row['country_lang']);?>">
            </div>
          </div>
          <div class="form-group row">
            <label class="col-sm-4 col-form-label form-control-sm text-sm-right" for="phone_code"><?php echo gks_lang('Κωδικός τηλεφώνων');?>:</label>
            <div class="col-sm-8">
              <input type="text" class="form-control form-control-sm myneedsave" id="phone_code" value="<?php echo htmlspecialchars_gks($row['phone_code']);?>">
            </div>
          </div>
      ...
      <div class="card gks_card_expand">
        ...
        <div class="card-body" <?php echo gks_card_body('kat');?>>       
          ...
          <div class="row">
            ...
            <div class="col-sm-8"><span class="form-control-plaintext form-control-sm"><?php if ($row['id_country']>0) echo $row['id_country'];?></span></div>
          </div>
          <div class="row">
...
var from_php_perm_ret_edit  =<?php echo gks_permission_user_can_action_javascript($my_wp_user_id, 'gks_country','edit',  $id);?>;
var from_php_perm_ret_add   =<?php echo gks_permission_user_can_action_javascript($my_wp_user_id, 'gks_country','add',   $id);?>;
var from_php_perm_ret_delete=<?php echo gks_permission_user_can_action_javascript($my_wp_user_id, 'gks_country','delete',$id);?>;
...
jQuery(document).ready(function($) {
  ...
  function mysubmit() {
    ...
    datasend+='&country_name='  +  encodeURIComponent($.base64.encode($("#mypostform #country_name").val().trim()));
    datasend+='&country_initials='  +  encodeURIComponent($.base64.encode($("#mypostform #country_initials").val().trim()));
    datasend+='&country_initials3='  +  encodeURIComponent($.base64.encode($("#mypostform #country_initials3").val().trim()));
    datasend+='&country_ISO_3166_1='  +  encodeURIComponent($("#mypostform #country_ISO_3166_1").val().trim());
    datasend+='&country_lang='  +  encodeURIComponent($.base64.encode($("#mypostform #country_lang").val().trim()));
    datasend+='&phone_code='  +  encodeURIComponent($.base64.encode($("#mypostform #phone_code").val().trim()));
    ...
    $.ajax({
			url: '/my/admin-country-item-exec.php?id=' + <?php echo $id;?>,
			type: 'POST',
			cache: false,
			dataType: 'json',
			data: datasend,
