...
require('UploadHandler_admin-hotel-room-type-item-photo-upload.php');


  
$mydir1=intval($_POST['hotel_room_type_id']).'/'; //.date('Y/m/d').'/';
$upload_dir = GKS_SITE_PATH.GKS_SITE_HTTPDOCS.'/my/uploads/room_type/'.$mydir1;
$upload_url='/my/uploads/room_type/'.$mydir1;
...
$upload_handler = new UploadHandler(array(
                        ...
                        'hotel_room_type_id' => intval($_POST['hotel_room_type_id']),
                        ));
                        

$my_page_title=gks_lang('Μεταφόρτωση φωτογραφίας σε τύπο δωματίου');
db_open();
stat_record();
