...
$gks_custom_prepare = gks_custom_table_item_prepare('gks_acc_inv',['from'=>'list']);
...
$filters[] = array(
  ...
  'vals' => array(
    ...
    array('value' => 104, 'text' => getAccInvStateDescr('070ypoekdosi'),  'sql' => "gks_acc_inv.inv_state='070ypoekdosi'"),
...
$filters[] = array(
  ...
  'title' => gks_lang('ΜΑΡΚ'),
  'has_custom_date' => true,
  'field' => 'gks_acc_inv.aade_invoicemark', 
  'has_custom_default' => -1,
  'multiselect' => true,
  'vals' => array(
      array('value' => -100, 'text' => gks_lang('Δεν έχει ορισθεί'),      'sql' => "(gks_acc_inv.aade_invoicemark is null or gks_acc_inv.aade_invoicemark='')"),
      array('value' => -101, 'text' => gks_lang('Έχει ορισθεί'),          'sql' => "(gks_acc_inv.aade_invoicemark <>'')"),
  ),
);
...
$filters[] = array(
  ...
  'has_custom_default' => -1,
  'multiselect' => true,
  'field'  => "gks_acc_inv.tropos_pliromis_via = '%V%'",
  'vals' => array(
      array('value' => -100, 'text' => gks_lang('Δεν έχει ορισθεί'),      'sql' => "(gks_acc_inv.tropos_pliromis_via='' or gks_acc_inv.tropos_pliromis_via is null)"),
      array('value' => -101, 'text' => gks_lang('Έχει ορισθεί'),          'sql' => "gks_acc_inv.tropos_pliromis_via<>''"),
  ),
  'sql' => "SELECT tropos_pliromis_via as id, tropos_pliromis_via AS descr
  FROM gks_acc_inv 
  where tropos_pliromis_via<>''
".(count($perm_id_company_ids)>0 ? " and gks_acc_inv.company_id in (".implode(',',$perm_id_company_ids).")" : "")."
".(count($perm_id_company_sub_ids)>0 ? " and gks_acc_inv.company_sub_id in (".implode(',',$perm_id_company_sub_ids).")" : "")."
".(count($perm_id_acc_journal_ids)>0 ? " and gks_acc_inv.inv_acc_journal_id in (".implode(',',$perm_id_acc_journal_ids).")" : "")."
".(count($perm_id_acc_seira_ids)>0 ? " and gks_acc_inv.inv_acc_seira_id in (".implode(',',$perm_id_acc_seira_ids).")" : "")."

  GROUP BY tropos_pliromis_via
  ORDER BY tropos_pliromis_via",    
);
...
$sortable = array(
  array('name' => 'soid', 'field' => 'gks_acc_inv.id_acc_inv'),
  array('name' => 'sood', 'field' => 'gks_acc_inv.inv_date'),
  ...
  array('name' => 'sonumber', 'field' => 'gks_acc_inv.inv_acc_number_int'),
  
  
  
  array('name' => 'soprint_date', 'field' => 'gks_acc_inv.print_date'),
  array('name' => 'soaade_send_date', 'field' => 'gks_acc_inv.aade_send_date'),
  array('name' => 'sostate', 'field' => 'gks_acc_inv.inv_state'),
  array('name' => 'souser', 'field' => GKS_WP_TABLE_PREFIX.'users.gks_nickname'),
  array('name' => 'soposotita', 'field' => 'gks_acc_inv.products_posotita'),
  ...
  //array('name' => 'sobalance', 'field' => 'gks_acc_inv.inv_state, affect_balance,affect_balance_poso*affect_balance_pros'),
  ...
  array('name' => 'sodispatch_date', 'field' => 'gks_acc_inv.dispatch_date'),
  ...
  array('name' => 'sotime', 'field' => 'gks_acc_inv.production_sum_time'),
  array('name' => 'sopoli', 'field' => 'gks_acc_inv.ma_poli'),
	array('name' => 'soassigned', 'field' => GKS_WP_TABLE_PREFIX.'users_assigned.gks_nickname'),
	array('name' => 'somerchantref', 'field' => 'gks_acc_inv.merchant_ref_trns'),
	...
	array('name' => 'socrmcode', 'field' => 'gks_acc_inv.crm_channel_code'),
	array('name' => 'sopos', 'field' => 'gks_pos.pos_name'),
	array('name' => 'soappmobile', 'field' => 'gks_erp_app_mobile.erp_app_mobile_name'),
...
'gks_acc_inv.acc_inv_ref_number',
...
$sql = "SELECT SQL_CALC_FOUND_ROWS gks_acc_inv.*, 
...
FROM ".$gks_custom_prepare['sql_all_list_from']." (((((((((((((((((((((((((((gks_acc_inv
...
if (isset($_GET['fparoxos'])) {
  $sql.= " and gks_acc_inv.aade_paroxos_id=".intval($_GET['fparoxos'])." ";
}
if (isset($_GET['paroxos_tf1_url_has'])) {
  $sql.= " and gks_acc_inv.paroxos_tf1_url_has=".intval($_GET['paroxos_tf1_url_has'])." ";
}
