...
$my_page_title=gks_lang('Δοκιμή σύνδεσης με πάροχο company_id').' '.$company_id;
db_open();
stat_record();
$perm_ret=gks_permission_user_can_action($my_wp_user_id, 'gks_company',('edit'),$company_id);
...
$sql_paroxos="select * from gks_company_paroxos where company_id=".$company_id;
