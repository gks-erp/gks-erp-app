...
$my_page_title=gks_lang('Αναφορά - Pivot Table - Παραγγελίες με Είδη');
$nav_active_array=array('sales','sales_orders_pivot3');
...
include_once('admin-reports-orders-pivot3_filters.php');
...
$_gks_session['temp']['wherepivot3']=$sql;
gks_erp_cookie_save();
...
jQuery(document).ready(function($) {
  ...
  $.ajax({
		url: '/my/admin-reports-orders-pivot3-json.php',
		type: 'POST',
		cache: false,
		dataType: 'json',
		data: '',
  ...
  $('#export_pivot_to_excel').click(function() {
    ...
    $.ajax({
			url: '/my/admin-reports-orders-pivot3-export-excel.php',
			type: 'POST',
			cache: false,
			dataType: 'json',
			data: datasend,
