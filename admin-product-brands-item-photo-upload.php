...
require('UploadHandler_admin-products-brands-item-photo-upload.php');


  
$mydir1=intval($_POST['product_brand_id']).'/'; //.date('Y/m/d').'/';
$upload_dir = GKS_SITE_PATH.GKS_SITE_HTTPDOCS.'/my/uploads/brands/'.$mydir1;
$upload_url='/my/uploads/brands/'.$mydir1;
...
$my_page_title=gks_lang('Μεταφόρτωση φωτογραφίας σε μάρκα');
db_open();
stat_record();
