...
gks_plugins_functions_run('admin_reports_orders_pivot3_filters_step1',array(
...
$filters=array_merge($filters,$gks_custom_orders_prepare['sql_filters']);
...
$search_fields=array_merge($search_fields,$gks_custom_orders_prepare['sql_search_fields']);
...
gks_orders_products.product_price_final_all_net, 
gks_orders_products.product_price_coupon_use, 
gks_orders_products.product_price_coupon_use_disabled


".$gks_custom_orders_prepare['sql_all_list_sele']."
".$gks_custom_eidi_prepare['sql_all_list_sele']."
".$plugin_sql_from_1."
FROM 
".$gks_custom_orders_prepare['sql_all_list_from']." 
".$gks_custom_eidi_prepare['sql_all_list_from']." 
".$plugin_sql_from_2;

$sql.=" ".$sql_FROM_cat_1." ".$sql_FROM_bra_1." ";

$sql.=" (((((((((((((((((((((((((((((  gks_orders_products 
...
".$gks_custom_orders_prepare['sql_all_list_left']." 
".$gks_custom_eidi_prepare['sql_all_list_left']." 
".$plugin_sql_from_3."
".$sql_FROM_cat_2." ".$sql_FROM_bra_2." 
