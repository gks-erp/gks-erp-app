...
//debug_mail(false,'admin-assets-item-photo-upload.php exec');



error_reporting(E_ALL | E_STRICT);
require('UploadHandler_admin-assets-item-photo-upload.php');


  
$mydir1=intval($_POST['asset_id']).'/'; //.date('Y/m/d').'/';
$upload_dir = GKS_SITE_PATH.GKS_SITE_HTTPDOCS.'/my/uploads/assets/'.$mydir1;
$upload_url='/my/uploads/assets/'.$mydir1;
...
$my_page_title=gks_lang('Μεταφόρτωση φωτογραφίας σε πάγιο');
db_open();
stat_record();
