...
$my_page_title=gks_lang('Προσθήκη συνδέσμου σε παραγγελία');
db_open();
stat_record();
...
$sql="insert into gks_orders_links (
order_id,url,mydate,ip,user_id
) values (
...
$html='<tr id="tr_links_url_'.$id.'">
  ...
  <td nowrap align="center">
    <i class="fas fa-trash-alt deleterow" data-deleteafter="gks_fnc_links_delete_after|'.$id.'" data-id="'.$id.'" data-model="gks_orders_links" style="font-size:120%;color:#dc3545;cursor:pointer;"></i>
  </td>
