...
$filters[] = array(
  ...
  'has_custom_default' => 1,
  //		'mywherepos'=>1,
  'vals' => gks_filter_date_vals(['field'=>'gks_whi_mov.print_date','future'=>false,'today'=>$today, 'today_vardia'=>$today_vardia]),
...
$filters[] = array(
  ...
  'has_custom_default' => 1,
  //		'mywherepos'=>1,
  'vals' => gks_filter_date_vals(['field'=>'gks_whi_mov.dispatch_date','future'=>false,'today'=>$today_vardia_this, 'today_vardia'=>$today_vardia_this, 'set_vardia'=>false,'local_time'=>true,'extra10' =>
    array(
    	array('value' => 102,
...
$filters=array_merge($filters,$gks_custom_whi_mov_prepare['sql_filters']);
...
//if ($gks_whi_mov_PRODUCTION) {
//  $sortable[] = array('name' => 'sopososto', 'field' => 'gks_whi_mov.production_pososto, gks_whi_mov.production_ergasies_total');
//}
//$sortable=array_merge($sortable,$gks_custom_whi_mov_prepare['sql_sortable']);
...
$search_fields=array_merge($search_fields,$gks_custom_whi_mov_prepare['sql_search_fields']);
...
gks_eshop_products.product_code, 
gks_eshop_products.product_descr, 
gks_whi_mov_products.product_quantity




".$gks_custom_whi_mov_prepare['sql_all_list_sele']."
".$gks_custom_eidi_prepare['sql_all_list_sele']."

FROM 
".$gks_custom_whi_mov_prepare['sql_all_list_from']." 
...
";
$sql.=$gks_custom_whi_mov_prepare['sql_all_list_left']." ";
