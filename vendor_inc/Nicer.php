...
class Nicer
{
     ...
     */
    public function __construct($value, $inspectMethods = false,$gks_show_extra=false)
    {
        $this->value = $value;
        $this->inspect_methods = $inspectMethods;
		    $this->gks_show_extra = $gks_show_extra;
     ...
     */
    public function render($for_echo)
    {
      //echo 'ffff'.$for_echo;die();
