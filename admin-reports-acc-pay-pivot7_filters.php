...
$filters=array_merge($filters,$gks_custom_acc_pay_prepare['sql_filters']);
...
$filters=array_merge($filters,$gks_custom_pay_method_prepare['sql_filters']);
...
//if ($gks_acc_pay_PRODUCTION) {
//  $sortable[] = array('name' => 'sopososto', 'field' => 'gks_acc_pay.production_pososto, gks_acc_pay.production_ergasies_total');
//}
//$sortable=array_merge($sortable,$gks_custom_acc_pay_prepare['sql_sortable']);
//$sortable=array_merge($sortable,$gks_custom_pay_method_prepare['sql_sortable']);
...
$search_fields=array_merge($search_fields,$gks_custom_acc_pay_prepare['sql_search_fields']);
$search_fields=array_merge($search_fields,$gks_custom_pay_method_prepare['sql_search_fields']);
...
gks_acc_pay_method.paymethod_total,
gks_payment_acquirers.payment_acquirer_name,
gks_payment_acquirers.payment_acquirer_type,
gks_aade_tropoi_pliromis.aade_tropos_pliromis_descr

".$gks_custom_acc_pay_prepare['sql_all_list_sele']."
".$gks_custom_pay_method_prepare['sql_all_list_sele']."


FROM 
".$gks_custom_acc_pay_prepare['sql_all_list_from']."
".$gks_custom_pay_method_prepare['sql_all_list_from']." 
";

$sql.="((((((((((((((((((((((gks_acc_pay_method ";

$sql.="
LEFT JOIN gks_acc_pay ON gks_acc_pay_method.acc_pay_id = gks_acc_pay.id_acc_pay)
LEFT JOIN gks_payment_acquirers ON gks_acc_pay_method.paymethod_id = gks_payment_acquirers.id_payment_acquirer)
";
$sql.=$gks_custom_acc_pay_prepare['sql_all_list_left']." ";
$sql.=$gks_custom_pay_method_prepare['sql_all_list_left']." ";
