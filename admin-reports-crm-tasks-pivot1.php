...
$my_page_title=gks_lang('Αναφορά - Pivot Table - Εργασίες');
$nav_active_array=array('crm','crm_tasks_pivot1');
...
$_gks_session['temp']['where_crm_tasks_pivot1']=$sql;
gks_erp_cookie_save();
...
jQuery(document).ready(function($) {
  ...
  $.ajax({
		url: '/my/admin-reports-crm-tasks-pivot1-json.php',
		type: 'POST',
		cache: false,
		dataType: 'json',
		data: '',
  ...
  $('#export_pivot_to_excel').click(function() {
    ...
    $.ajax({
			url: '/my/admin-reports-crm-tasks-pivot1-export-excel.php',
			type: 'POST',
			cache: false,
			dataType: 'json',
			data: datasend,
