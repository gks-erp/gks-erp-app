...
require('UploadHandler_admin-hotel-room-item-photo-upload.php');


  
$mydir1=intval($_POST['hotel_room_id']).'/'; //.date('Y/m/d').'/';
$upload_dir = GKS_SITE_PATH.GKS_SITE_HTTPDOCS.'/my/uploads/room/'.$mydir1;
$upload_url='/my/uploads/room/'.$mydir1;
