...
"update gks_hr_program_status set hr_program_status_descr='Draft' where id_hr_program_status=1",
"update gks_hr_program_status set hr_program_status_descr='Evaluation' where id_hr_program_status=20",
"update gks_hr_program_status set hr_program_status_descr='Approved' where id_hr_program_status=100",
"update gks_hr_program_status set hr_program_status_descr='Rejected' where id_hr_program_status=200",

"update gks_hr_program_vardia set hr_program_vardia_descr='Morning 1' where id_hr_program_vardia=10",
"update gks_hr_program_vardia set hr_program_vardia_descr='Morning 2' where id_hr_program_vardia=20",
"update gks_hr_program_vardia set hr_program_vardia_descr='Morning 3' where id_hr_program_vardia=30",
"update gks_hr_program_vardia set hr_program_vardia_descr='Morning 4' where id_hr_program_vardia=40",
"update gks_hr_program_vardia set hr_program_vardia_descr='Afternoon 1' where id_hr_program_vardia=50",
"update gks_hr_program_vardia set hr_program_vardia_descr='Afternoon 2' where id_hr_program_vardia=60",
"update gks_hr_program_vardia set hr_program_vardia_descr='Afternoon 3' where id_hr_program_vardia=70",
"update gks_hr_program_vardia set hr_program_vardia_descr='Afternoon 4' where id_hr_program_vardia=80",
"update gks_hr_program_vardia set hr_program_vardia_descr='Evening 1' where id_hr_program_vardia=90",
"update gks_hr_program_vardia set hr_program_vardia_descr='Evening 2' where id_hr_program_vardia=100",
"update gks_hr_program_vardia set hr_program_vardia_descr='Evening 3' where id_hr_program_vardia=110",
"update gks_hr_program_vardia set hr_program_vardia_descr='Evening 4' where id_hr_program_vardia=120",
"update gks_hr_program_vardia set hr_program_vardia_descr='Fri-Sun' where id_hr_program_vardia=200",
"update gks_hr_program_vardia set hr_program_vardia_descr='Weekend' where id_hr_program_vardia=210",
"update gks_hr_program_vardia set hr_program_vardia_descr='Leave' where id_hr_program_vardia=500",
"update gks_hr_program_vardia set hr_program_vardia_descr='Day off' where id_hr_program_vardia=510",
"update gks_hr_program_vardia set hr_program_vardia_descr='Sick leave' where id_hr_program_vardia=520",
