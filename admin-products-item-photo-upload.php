...
require('UploadHandler_admin-products-item-photo-upload.php');


  
$mydir1=intval($_POST['product_id']).'/'; //.date('Y/m/d').'/';
$upload_dir = GKS_SITE_PATH.GKS_SITE_HTTPDOCS.'/my/uploads/products/'.$mydir1;
$upload_url='/my/uploads/products/'.$mydir1;
...
$my_page_title=gks_lang('Μεταφόρτωση φωτογραφίας σε είδος');
db_open();
stat_record();
