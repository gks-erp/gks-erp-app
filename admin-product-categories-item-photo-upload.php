...
require('UploadHandler_admin-products-categories-item-photo-upload.php');


  
$mydir1=intval($_POST['product_category_id']).'/'; //.date('Y/m/d').'/';
$upload_dir = GKS_SITE_PATH.GKS_SITE_HTTPDOCS.'/my/uploads/categories/'.$mydir1;
$upload_url='/my/uploads/categories/'.$mydir1;
...
$my_page_title=gks_lang('Μεταφόρτωση φωτογραφίας σε κατηγορία');
db_open();
stat_record();
