...
$my_page_title=gks_lang('Στατιστικά χρήστη').': '.$username;
...
if (!$result) debug_mail(false,'stat user error sql',$query);
...
<p align="center">Last
	<span <?php if ($lastercs==300) echo $mybackcolor;?> ><a href="?username=<?php echo $username?>&c=300">300</a></span>
	<span <?php if ($lastercs==1000) echo $mybackcolor;?> ><a href="?username=<?php echo $username?>&c=1000">1000</a></span>
	<span <?php if ($lastercs==2000) echo $mybackcolor;?> ><a href="?username=<?php echo $username?>&c=2000">2.000</a></span>
	<span <?php if ($lastercs==5000) echo $mybackcolor;?> ><a href="?username=<?php echo $username?>&c=5000">5.000</a></span>
	<span <?php if ($lastercs==10000) echo $mybackcolor;?> ><a href="?username=<?php echo $username?>&c=10000">10.000</a></span>
	<span <?php if ($lastercs==-1) echo $mybackcolor;?> ><a href="?username=<?php echo $username?>&c=-1">All</a></span>
Hits</p>
