...
$fileurl=GKS_SITE_URL.'my/admin-orders-item-aws-start.php?cache='.time().rand(1000,9999).rand(1000,9999).rand(1000,9999).'&id='.$id;



//if (isset($argv[1])==false) die();
//$id=intval($argv[1]);
//
//$fileurl=GKS_SITE_URL.'my/admin-orders-item-aws-start.php?id='.$id;
