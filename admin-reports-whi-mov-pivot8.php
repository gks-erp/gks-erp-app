...
$my_page_title=gks_lang('Αναφορά - Pivot Table - Δελτία');
...
$_gks_session['temp']['wherepivot8']=$sql;
gks_erp_cookie_save();
...
jQuery(document).ready(function($) {
  ...
  $.ajax({
		url: '/my/admin-reports-whi-mov-pivot8-json.php',
		type: 'POST',
		cache: false,
		dataType: 'json',
		data: '',
  ...
  $('#export_pivot_to_excel').click(function() {
    ...
    $.ajax({
			url: '/my/admin-reports-whi-mov-pivot8-export-excel.php',
			type: 'POST',
			cache: false,
			dataType: 'json',
			data: datasend,
