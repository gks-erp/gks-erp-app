...
$my_page_title=gks_lang('Αναφορά - Pivot Table - Πληρωμές με Μέθοδο');
$nav_active_array=array('accounting','accounting_pay_pivot7');
...
include_once('admin-reports-acc-pay-pivot7_filters.php');
...
$_gks_session['temp']['wherepivot7']=$sql;
gks_erp_cookie_save();
...
jQuery(document).ready(function($) {
  ...
  $.ajax({
		url: '/my/admin-reports-acc-pay-pivot7-json.php',
		type: 'POST',
		cache: false,
		dataType: 'json',
		data: '',
  ...
  $('#export_pivot_to_excel').click(function() {
    ...
    $.ajax({
			url: '/my/admin-reports-acc-pay-pivot7-export-excel.php',
			type: 'POST',
			cache: false,
			dataType: 'json',
			data: datasend,
